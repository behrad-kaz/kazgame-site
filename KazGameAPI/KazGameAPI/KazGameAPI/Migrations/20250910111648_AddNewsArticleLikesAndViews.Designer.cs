...
namespace KazGameAPI.Migrations
{
    ...
    [Migration("20250910111648_AddNewsArticleLikesAndViews")]
    partial class AddNewsArticleLikesAndViews
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NewsArticle+UserLikedArticle", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UserFavoriteGame", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NewsArticle+UserLikedArticle", b =>
                {
                    b.HasOne("NewsArticle", "Article")
                        .WithMany("LikedByUsers")
                        .HasForeignKey("ArticleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("KazGameAPI.Models.User", "User")
            ...
            modelBuilder.Entity("UserFavoriteGame", b =>
                {
                    b.HasOne("KazGameAPI.Models.Product", "Product")
